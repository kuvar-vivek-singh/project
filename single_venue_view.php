...
<?php
$venue_id= $_GET["venue_details"];
$venue_details="SELECT `venue_id`, `venue_name`, `photos`, `about_venue`, `venue_type`, `city`, `rating`, `area`, `price`, `No_guests`, `created_date` FROM `venue` WHERE venue_id='$venue_id'";
$queryexe=mysqli_query($conn,$venue_details);
$venue=mysqli_fetch_assoc($queryexe);
?>
<div class="container-fluid">
    ...
    <div class="row jumbotron">
        ...
        <div class="col-md-6">
            <h5 class="text-muted">Area : <?php echo $venue['area'] ?></h5>
            <img class="img-fluid" src="<?php echo $venue["photos"]?>" alt="<?php echo $venue['venue_name'] ?>" l>
        </div>
        <!-- End of first column that is image of events-->
        <!--Description of events and rating details-->
        <div class="col-md-6 ">
            <div class="">
                <h4 class="text-capitalize text-success"><?php echo $venue["venue_name"] ?></h4>
                <br>
        ...
        $half_rat="<span class='fa fa-star-half-o rating'></span>";
            ...
            <p><?php echo substr($venue["about_venue"],0,230)?> ...</p>
            <i class="fa fa-map-marker" aria-hidden="true" style="color:red"></i> &nbsp<?php echo $venue["city"]?>
            <h4>Price: &#x20B9;<i></i> <?php echo $venue["price"]?></h4>
            <h5><?php echo $venue['venue_type'] ?></h5>
